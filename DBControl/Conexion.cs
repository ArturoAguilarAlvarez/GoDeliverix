...
namespace DBControl
{
    public class Conexion
    {
        ...
        //private readonly SqlConnection myVar = new SqlConnection("Data Source=den1.mssql5.gear.host;Initial Catalog=deliverix;Persist Security Info=True;User ID=deliverix;Password=Yj8q4DyP!d!o");
        //Conexion Toshiba
        ...
        //Conexion HP
        //private readonly SqlConnection myVar = new SqlConnection(connectionString: @"Data Source=192.168.1.69;Initial Catalog=deliverix;Persist Security Info=True;User ID=sa;Password=12345678");
