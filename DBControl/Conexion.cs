...
namespace DBControl
{
    public class Conexion
    {
        ...
        //Conexion HP
        //private SqlConnection myVar = new SqlConnection(connectionString: @"Data Source=192.168.1.65;Initial Catalog=deliverix;Persist Security Info=True;User ID=sa;Password=12345678");
