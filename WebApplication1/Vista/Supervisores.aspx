<%@ Page Title="" Language="C#" MasterPageFile="MasterDeliverix.Master" AutoEventWireup="true" CodeBehind="Supervisores.aspx.cs" Inherits="WebApplication1.Vista.Supervisores" %>
            ...
            <asp:Panel runat="server" ID="PanelDeBusqueda">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-heading text-center">
                        <h5>Busqueda de SUPERVISORES</h5>
                    </div>
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <asp:Panel runat="server" ID="pnlDatosGenerales">
                        <div class="row">
                            <asp:TextBox ID="txtUidUsuario" CssClass="hide" runat="server" />
                            <div class="col-md-4">
                                <h6>Nombre*</h6>
