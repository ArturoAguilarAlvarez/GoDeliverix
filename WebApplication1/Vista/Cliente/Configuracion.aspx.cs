...
namespace WebApplication1.Vista.Cliente
{
    public partial class Configuracion : System.Web.UI.Page
    {
        ...
        protected void Cargausuario(string Uidusuario)
        {
            ...
            DateTime Fecha = DateTime.Parse(MVUsuario.DtmFechaDeNacimiento);
        ...
        protected void btnDatosUbicacion_Click(object sender, EventArgs e)
        {
            ...
            PlantillaMensajeVentana = "<label>" + txtIdentificadorDeDireccion.Text + "</label>";
            DbLatitud = double.Parse(latitud.Text);
            DbLongitud = double.Parse(lonjitud.Text);
            MuestraUbicacionEnMapa(DbLatitud, DbLongitud, PlantillaMensajeVentana, 18);
        }
        ...
        {
            string url = string.Format("https://ipinfo.io/geo");
            using (WebClient client = new WebClient())
            {
                ...
                MuestraUbicacionEnMapa( double.Parse("21.2383"), double.Parse("-86.8675"), PlantillaMensajeVentana, 17);
            }
        }
    }
}