    ...
    public partial class Supervisores : System.Web.UI.Page
    {
        ...
        protected void GVWEmpresaNormal_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                //    tooltip.ToolTipTitle = "Activo";
                //    ESTATUS.CssClass = "glyphicon glyphicon-ok";
                //    ESTATUS.ToolTip = tooltip;
                //}
        ...
        protected void MuestraEmpresaEnGestion(string valor)
        {
            ...
            MVSucursales.ObtenerSucursal(MVSucursales.obtenerUidSucursal(valor));
        ...
        protected void BuscarEmpresasBusquedaNormal(object sender, EventArgs e)
        {
            ...
            Guid UidPerfil = new Guid("81232596-4c6b-4568-9005-8d4a0a382fda");
        ...
        protected void BuscarEmpresasBusquedaAmpliada(object sender, EventArgs e)
        {
            ...
            {
                MVUsuarios.DatosGridViewBusquedaAmpliada("81232596-4c6b-4568-9005-8d4a0a382fda");
                CargaGrid("Ampliada");
                CargaGrid("Normal");
                lblBAFiltrosVisibilidad.Text = " Mostrar";
                PanelFiltrosBusquedaAmpliada.Visible = false;
        ...
        protected void GuardarDatos(object sender, EventArgs e)
        {
            ...
            if (txtDNombre.Text != string.Empty && txtDApellidoPaterno.Text != string.Empty && txtDApellidoMaterno.Text != string.Empty && DDLDEstatus.SelectedItem.Value != "0" && txtdidentificador.Text != string.Empty)
            {
                ...
                string TIPODEUSUARIO = "Supervisor";
                ...
                string PerfilDeUsuario = "81232596-4c6b-4568-9005-8d4a0a382fda";
                ...
                if (AccionesDeLaPagina == "NuevoRegistro")
                {
                    ...
                    else
                    {
                        ...
                        if (MVUsuarios.GuardaUsuario(UidUsuario: uidusuaro, Nombre: Nombre, ApellidoPaterno: ApellidoPaterno, ApellidoMaterno: ApellidoMaterno, usuario: usuario, password: password, fnacimiento: fechaDeNacimiento, perfil: PerfilDeUsuario, estatus: estatus, TIPODEUSUARIO: TIPODEUSUARIO, IdEmpresa: UidEmpresa, Sucursal: UidSucursal))
                        {
                            if (MVDireccion.ListaDIRECCIONES.Count > 0)
                            {
                                MVDireccion.GuardaListaDeDirecciones(MVDireccion.ListaDIRECCIONES, uidusuaro, "asp_AgregaDireccionUsuario", "Usuario");
                            }
                            //Guarda el correo electronico
                            if (!string.IsNullOrEmpty(txtDCorreoElectronico.Text))
                            {
                                MVCorreoElectronico.AgregarCorreo(uidusuaro, "Usuario", txtDCorreoElectronico.Text, Guid.NewGuid());
                            }
                        ...
                        if (resultado == true)
                        {
                            lblEstado.Text = "Empresa agregada";
                        }
                        else if (resultado == false)
                        {
                            lblEstado.Text = "Empresa no agregada";
                        }
                        btnGuardar.Visible = false;
                        btnCancelar.Visible = false;
                        pnlDireccion.Visible = false;
        ...
        protected void GVDireccion_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                //    Eliminar.CssClass = "btn btn-sm btn-default disabled";
                //}
                //else if (GVDireccion.Rows.Count > 1)
                //{
                //    if (AccionesDeLaPagina != string.Empty)
                //    {
                //        Eliminar.Enabled = true;
