    ...
    public partial class Clientes : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                MVUsuarios.CargaPerfilesDeUsuario("4F1E1C4B-3253-4225-9E46-DD7D1940DA19");
        ...
        protected void GVWEmpresaNormal_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (e.Row.Cells[7].Text == "CLIENTE")
                {
                    PERFIL.CssClass = "glyphicon glyphicon-piggy-bank";
                    PERFIL.ToolTip = "Cliente";
                }
            }
        }
        ...
        protected void CargaGrid(string Busqueda)
        {
            ...
            switch (Busqueda)
            {
                case "Normal":
                    ...
                    MVUsuarios.BusquedaDeUsuario(UIDPERFIL: new Guid("4F1E1C4B-3253-4225-9E46-DD7D1940DA19"), UidEmpresa: new Guid(Session["UidEmpresaSistema"].ToString()));
        ...
        {
            Guid UidPerfil = new Guid("4F1E1C4B-3253-4225-9E46-DD7D1940DA19");
        ...
        protected void GuardarDatos(object sender, EventArgs e)
        {
            ...
            if (txtDNombre.Text != string.Empty && txtDApellidoPaterno.Text != string.Empty && txtDApellidoMaterno.Text != string.Empty && DDLDEstatus.SelectedItem.Value != "0")
            {
                #region Variables
                //Datos generales
                ...
                string PerfilDeUsuario = "4F1E1C4B-3253-4225-9E46-DD7D1940DA19";
                ...
                if (string.IsNullOrEmpty(txtUidUsuario.Text))
                {
                    ...
                    else
                    {
                        ...
                        if (MVUsuarios.LISTADEUSUARIOS.Count == 0)
                        {
                            ...
                            resultado = MVUsuarios.GuardaUsuario(UidUsuario: UidUsuario, Nombre: Nombre, ApellidoPaterno: ApellidoPaterno, ApellidoMaterno: ApellidoMaterno, usuario: usuario, password: password, fnacimiento: fechaDeNacimiento, perfil: PerfilDeUsuario, estatus: estatus,TIPODEUSUARIO: TIPODEUSUARIO,IdEmpresa: Guid.Empty);
                ...
                if (!string.IsNullOrEmpty(txtUidUsuario.Text))
                {
                    ...
                    resultado = MVUsuarios.ActualizarUsuario(UidUsuario, Nombre, ApellidoPaterno, ApellidoMaterno, usuario, password, fechaDeNacimiento, PerfilDeUsuario, estatus);
        ...
        protected void txtBAUSuario_TextChanged(object sender, EventArgs e)
        {
